...
@Component({
  selector: 'app-domain-details-events-component',
  templateUrl: 'domain.details.events.component.html',
})
export class DomainDetailsEventsComponent implements OnInit {
  total = 0;
