...
@Component({
  selector: 'app-domain-details-alerts-component',
  templateUrl: 'domain.details.alerts.component.html',
})
export class DomainDetailsAlertsComponent implements OnInit {
  total = 0;
